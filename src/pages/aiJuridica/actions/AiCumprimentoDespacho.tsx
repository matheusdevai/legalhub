...
export function AiCumprimentoDespacho({ processo }: Props) {
  ...
  const podeGerar = despachoTexto.trim().length > 0 || attachments.length > 0
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-3">
        ...
        {!podeGerar && !loading && (
          <span className="text-xs text-slate-400">Cole o texto do despacho ou anexe um arquivo para gerar.</span>
        )}
      </div>
