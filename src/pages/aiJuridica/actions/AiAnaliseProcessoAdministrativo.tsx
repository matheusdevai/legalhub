...
// necessários para essa análise (ex: movimentos, prazos, órgão julgador) e
// enriquecer a exibição do resultado. Editar SÓ este arquivo — os outros 5
// componentes de ação vivem em arquivos separados nesta mesma pasta.
interface Props {
  ...
  async function gerar() {
    ...
    try {
      const result = await runAiGeneration({
        ...
        // TODO(fase 2): trocar pelo contexto real (nº processo, órgão, andamentos, etc.)
        input_context: {
  ...
  return (
    <div className="space-y-3">
      <p className="text-sm text-slate-500 dark:text-slate-400">
        Análise de processo administrativo (INSS, órgãos públicos, etc.) via IA.
      </p>
