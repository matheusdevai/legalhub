                        ...
                        {usage && (
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            {[
                              ...
                              { icon: Sparkles,  label: 'Excelência (IA)', used: usage.aiGenerations, limit: currentPlan?.max_ai_generations_month ?? null },
                            ].map(item => {
                          ...
                          return (
                            <div key={plan.id} className={cn(
                              ...
                              <ul className="mt-4 space-y-1.5 text-xs text-gray-600 dark:text-gray-400 flex-1">
                                ...
                                <li>Excelência (IA): {plan.max_ai_generations_month ?? 'ilimitada'}{plan.max_ai_generations_month ? '/mês' : ''}</li>
                              </ul>
                              {isBillingAdmin && (
                                <Button
                                  className="mt-4"
