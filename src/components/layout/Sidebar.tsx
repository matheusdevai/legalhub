  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: 'radial-gradient(ellipse at 50% -20%, rgba(56,189,248,0.12) 0%, transparent 70%)' }}
      />
                ...
                disabled ? (
                  ...
                  <NavLink
                    ...
                    style={({ isActive }) => isActive ? {
                      ...
                      boxShadow: 'inset 1px 0 0 rgba(56,189,248,0.6)',
                    } : {}}
                  >
                    {({ isActive }) => (
                      <>
                        ...
                        {isActive && collapsed && (
                          <span className="absolute right-0 top-1/2 -translate-y-1/2 w-0.5 h-5 bg-sky-400 rounded-l-full" />
                        )}
                      </>
                    )}
                  </NavLink>
        ...
        {isSuperAdmin && (
          <div>
            ...
            <NavLink to="/admin" title={collapsed ? 'Admin' : undefined}
              ...
              {({ isActive }) => (
                <>
                  <Shield style={{ width: 15, height: 15 }} className={cn('flex-shrink-0', isActive ? 'text-sky-400' : 'text-white/40 group-hover:text-white/70')} />
